...
export class SvelteWebviewProvider {
  public static currentPanel: SvelteWebviewProvider | undefined;
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (SvelteWebviewProvider.currentPanel) {
      SvelteWebviewProvider.currentPanel._panel.reveal(column);
      return;
    }
    ...
    SvelteWebviewProvider.currentPanel = new SvelteWebviewProvider(
      panel,
      extensionUri
    );
  }
  ...
  public dispose() {
    SvelteWebviewProvider.currentPanel = undefined;
